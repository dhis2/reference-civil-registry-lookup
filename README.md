...
This reference implementation illustrates a [DHIS2 Capture app plugin](https://developers.dhis2.org/docs/capture-plugins/developer/getting-started) that looks up and transforms data from a civil registry before prefilling fields with personal identifiable and demographic information in a form used to carry out an [Anti-Tuberculosis Drug Resistance Survey (Anti-DRS)](https://docs.dhis2.org/en/implement/health/tuberculosis/anti-tuberculosis-drug-resistance-survey-drs/design.html). 
...
3. Fill out the form with the following details:
   ...
   | Authentication Scheme | `API Token`             | The mediator is kept minimally secure from unauthorised access with an API token. A real-life implementation would more than likely require better access control. |
